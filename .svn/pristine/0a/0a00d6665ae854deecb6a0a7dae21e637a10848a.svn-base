...
public class QryMeterdataTabExtAction implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,
		...
		System.out.println("QryMeterdataTabExtAction param:" + paramMap);
		// pagination info
		...
		try {
			Map retMap = getDao().selSysTabAsPage(paramMap, start, limit);
			...
			System.out.println("QryMeterdataTabExtAction -jsonStr:" + jsonStr);
