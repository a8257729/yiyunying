...
public class QryStaffForPopupExt implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,
		...
		System.out.println("QryStaffForPopupExt param:" + paramMap);
		// pagination info
		...
		try {
			Map retMap = getDao().selStaffAsPage(paramMap, start, limit);
			...
			System.out.println("QryStaffForPopupExt -jsonStr:" + jsonStr);
