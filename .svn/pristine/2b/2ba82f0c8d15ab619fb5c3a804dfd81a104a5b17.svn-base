...
var proxy = new Ext.data.HttpProxy({
    api: {
        read : '/MOBILE/ExtServlet?actionName=system/SelJsonCreateAction',
        create : '/MOBILE/ExtServlet?actionName=system/SelJsonCreateAction',
        update: '/MOBILE/ExtServlet?actionName=system/SelJsonCreateAction',
        destroy: '/MOBILE/ExtServlet?actionName=system/SelJsonCreateAction'
    }
});
...
var reader = new Ext.data.JsonReader({
    ...
    {name: 'last1', allowBlank: false},
    {name: 'last2', allowBlank: false}
]);
...
var userColumns =  [
    ...
    {header: "Last1", width: 50, sortable: true, dataIndex: 'last1', editor: textField},
    {header: "Last2", width: 50, sortable: true, dataIndex: 'last2', editor: textField}
];
