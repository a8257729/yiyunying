...
public class OrgPrivJsonUtil {

	private final static  Logger logger = Logger.getLogger(OrgPrivJsonUtil.class);
	...
	public static String getPrivSelJson(Map privClassMap, Privilege[] privs){
      ...
      //  logger.debug("getPrivSelJson:"+privClassMap);
        
        try {
	 		Map privClass = new HashMap();
	 		privClass.put("id", "0");
	 		privClass.put("text", "可配置权限");
	 		privClass.put("leaf", false);
	 		//privClass.put("checked",false);
	 		privClass.put("children", new ArrayList());
	 		...
	 		//logger.debug("getPrivSelJson"+JsonUtil.getJsonByList(parentList));
	...
	public static String getJobPrivSelJson(Map privClassMap, JobPrivilege[] privs){
