...
public class MenuDAOImpl extends BaseDAOImpl implements MenuDAO {
	...
	public Map getMenuListByModule(int moduleId) throws DataAccessException {
		...
		System.out.println("getMenuListByModule sql"+sqlBuf.toString());
		Map retMap = populateQueryByMap(sqlBuf, 0, 0);
		System.out.println("menu retMap "+retMap );
		return retMap;
	}
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(m.isExitActionByModule(207,"待审核文档"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
