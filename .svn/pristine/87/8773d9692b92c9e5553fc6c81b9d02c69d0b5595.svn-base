 ...
 */
package com.ztesoft.mobile.pn.xmpp.net;
...
import com.ztesoft.mobile.pn.xmpp.ssl.SSLConfig;
import com.ztesoft.mobile.pn.xmpp.ssl.SSLKeyManagerFactory;
import com.ztesoft.mobile.pn.xmpp.ssl.SSLTrustManagerFactory;
