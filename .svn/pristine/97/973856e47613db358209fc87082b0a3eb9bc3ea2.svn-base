...
public class QryTransRuleItemsListExtAction implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,
		...
		System.out.println("QryTransRuleItemsListExtAction param:" + paramMap);
		// pagination info
		...
		try {
			Map retMap = getDAO().selItemsAsPage(paramMap, start, limit);
			...
			System.out.println("QryTransRuleItemsListExtAction -jsonStr:"
					+ jsonStr);
