...
Ext.onReady(function(){
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/JobPrivGrantTreeAction',
        	baseParams: {jobId:jobId,_jobId:_jobId,specialJobId:specialJobId,methodName:methodName}
        }),
    ...
    Ext.get('comitBtn').on('click',function(e){
		...
		callRemoteFunction("com.zterc.uos.oaas.service.jobprivmanager.JobPrivilegeManagerWeb", "updateJobPrivs", _jobId, privs, grantPrivs);
