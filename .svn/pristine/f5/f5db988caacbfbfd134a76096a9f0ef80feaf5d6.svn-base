...
/**
 * @author FL
 * description :清理规则查询列表Action
 */
public class QryCleanRoleListAction implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			Map retMap = getCleanRuleConfigDAO().getCleanRoleList(paramMap,start,limit);
