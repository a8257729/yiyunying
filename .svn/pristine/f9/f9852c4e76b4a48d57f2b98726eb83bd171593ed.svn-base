...
public class QryJobForPopupExt implements BaseAction {
	public Object doAction(HttpServletRequest request,
		...
		System.out.println("QryJobForPopupExt param:" + paramMap);
		// pagination info
		...
		try {
			Map retMap = getDao().selJobAsPage(paramMap, start, limit);
			...
			System.out.println("QryJobForPopupExt -jsonStr:" + jsonStr);
