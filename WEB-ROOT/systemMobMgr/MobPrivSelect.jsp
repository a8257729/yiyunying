...
Ext.onReady(function(){
    ...
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobRolePrivTreeAction&type=allpriv',
        	baseParams: {jobId:jobId,specialJobId:specialJobId,roleId:roleId,staffId:staffId,methodName:methodName}
        }),
    ...
    var spciPrivTree = new Ext.tree.TreePanel({
        ...
        autoScroll:true,
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobRolePrivTreeAction&type=haspriv',
    ...
    Ext.get('comitBtn').on('click',function(e){
    	...
    	//callRemoteFunction("com.zterc.uos.oaas.service.roleprivmanager.RolePrivilegeManager", "updatePrivs",roleId, privs);
		...
		var retMap = invokeAction("/mobsystem/InsertRolePrivAction", paramObj);
