...
Ext.onReady(function(){
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobilePrivConfSelAction&type=allpriv',
        	    baseParams: {jobId:jobId,specialJobId:specialJobId,_jobId:_jobId,staffId:staffId,methodName:methodName}
        }),
    ...
    var rolePrivTree = new Ext.tree.TreePanel({
        autoScroll:true,
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/JobRolePrivTreeAction',
        	baseParams: {_jobId:_jobId}
        }),
        containerScroll: true,
        border: true,
        animCollapse: false, 
    ...
    var spciPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	...
        	baseParams: {_defaultJobId:-1,_jobId:_jobId}
        }),
        enableDD:true,
        containerScroll: true,
        border: true,
