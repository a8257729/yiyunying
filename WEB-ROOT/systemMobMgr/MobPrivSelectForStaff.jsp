...
//目录树初始化
    ...
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobPrivConfSelAction&type=allpriv',
    ...
    var spciPrivTree = new Ext.tree.TreePanel({
        ...
        autoScroll:true,
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobPrivConfSelAction&type=haspriv',
        	baseParams: {_defaultJobId:_defaultJobId,_jobId:-1}
        }),
        enableDD:true,
        containerScroll: true,
        border: true,
