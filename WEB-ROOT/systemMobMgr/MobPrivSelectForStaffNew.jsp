		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1">
			...
			<tr>
				<td colspan = 4 align='center'><br><br>
                    ...
                    <%--
					<input id = "testBtn" type="button" value="测试使用" />
					--%>
				</td>
			</tr>
		</table>
...
//目录树初始化
    ...
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobilePrivConfSelAction&type=allpriv',
        	    baseParams: {jobId:jobId,specialJobId:specialJobId,_jobId:_jobId,_defaultJobId:_defaultJobId,staffId:staffId,methodName:methodName}
        }),
    ...
    var spciPrivTree = new Ext.tree.TreePanel({
        ...
        autoScroll:true,
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/MobilePrivConfSelAction&type=haspriv',
        	baseParams: {_defaultJobId:_defaultJobId,_jobId:_jobId}
        }),
        enableDD:true,
        containerScroll: true,
        border: true,
    ...
    */
    ...
    Ext.get('comitBtn').on('click',function(e){
    	...
    	paramObj.priv = privs;    	
    	paramObj._defaultJobId =_defaultJobId;
    	paramObj.strpriv = privs.join();
		paramObj.type = "staffPrivAdd";			
					
		var retMap = invokeAction("/mobsystem/InsertPrivAction", paramObj);
    ...
    /* Ext.get('testBtn').on('click',function(e){
    	invokeAction("/mobsystem/MypageTest");
    }); */
