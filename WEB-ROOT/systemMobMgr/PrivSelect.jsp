...
Ext.onReady(function(){
    ...
    var confPrivTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/RolePrivGrantTreeAction',
        	baseParams: {jobId:jobId,specialJobId:specialJobId,roleId:roleId,methodName:methodName}
        }),
    ...
    var spciPrivTree = new Ext.tree.TreePanel({
        autoScroll:true,
        loader: new Ext.tree.TreeLoader({
        	dataUrl:'/MOBILE/ExtServlet?actionName=system/RolePrivHoldTreeAction',
