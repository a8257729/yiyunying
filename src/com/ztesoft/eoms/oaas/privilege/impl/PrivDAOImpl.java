package com.ztesoft.eoms.oaas.privilege.impl;
...
//        logger.debug("findPrivsJobNotHold sb:"+sb.toString());
//
//    	logger.debug("jobId:"+jobId);
//    	logger.debug("defaultJobId:"+defaultJobId);
//    	logger.debug("parentId:"+parentId);
        ...
        try {
            ...
            while (rs.next()) {
               ...
               // logger.debug("******************"+rs.getString("PRIV_CODE"));
            }
            return resultList;
...
//    	logger.debug("findPrivsByJob sb:"+sb.toString());
//    	logger.debug("jobId:"+jobId);
//    	logger.debug("parentId:"+parentId);
    ...
    public List findPrivClassesList(int parentId) throws SQLException {
        ...
        //logger.debug("findPrivClassesList sql:"+sb.toString());
        ...
        try {
            ...
            //logger.debug("findPrivClassesList resultList"+resultList);
            return resultList;
        }catch (Exception e) {
    ...
    public List findPrivByClass(int privClassId) throws SQLException {
    	...
    	//logger.debug("findPrivByClass sql:"+sb.toString());
        ...
        try {
            ...
            //logger.debug("findPrivByClass resultList"+resultList);
            return resultList;
        }catch (Exception e) {
			//logger.debug(e.getMessage());
			return null ; 
    ...
    public List findJobPrivTreeList(int parentId,int jobId) throws SQLException {
        ...
        try {
            ...
            //.debug("findPrivClassesList resultList"+resultList);
            return resultList;
        }catch (Exception e) {
			//logger.debug(e.getMessage());
			return null ; 
    ...
    public List findAllJobPrivTreeList(int parentId,int jobId) throws SQLException {
        ...
        //logger.debug("findAllJobPrivTreeList sql:"+sb.toString());
        ...
        try {
           ...
           // logger.debug("findAllJobPrivTreeList resultList"+resultList);
            return resultList;
        }catch (Exception e) {
			//logger.debug(e.getMessage());
			return null ; 
