...
public final class ValidateHelper {
    ...
    public final static void validate(Long l, String eInfo) throws
            RequiredException {
        if (!validateNotNull(l)) {
            throw new RequiredException(eInfo);
        }
    }

    public final static void validate(String s, String eInfo) throws
            RequiredException {
        if (!ValidateHelper.validateNotEmpty(s)) {
            throw new RequiredException(eInfo);
        }

    }

    public final static void validate(Integer i, String eInfo) throws
            RequiredException {
    ...
    public static void isNull(Object object, String message) {
        if (!ValidateHelper.validateNotNull(object)) {
    ...
    public static void hasText(String text, String message) {
        if (!ValidateHelper.validateNotEmpty(text)) {
            throw new IllegalArgumentException(message);
        }
    }
   ...
   public static void notEmpty(String str,String message){
     if(!ValidateHelper.validateNotEmpty(str)){
       throw new IllegalArgumentException(message);
     }
   }
