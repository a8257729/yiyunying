...
final public class Dom4jUtils {
     ...
     */
    public static Element child(Element element, String name, boolean optional) throws
            XMLDocException {
     ...
     */
    public static int getAttributeAsInt(Element element, String name,
                                        int defaultValue, boolean optional) throws
            XMLDocException {
     ...
     */
    public static long getAttributeAsLong(Element element, String name,
                                          long defaultValue, boolean optional) throws
            XMLDocException {
        String value = getAttribute(element, name, optional);
        if ((optional) && ((value == null) || (value.equals("")))) {
            return defaultValue;
    ...
    /**
     * 给定输入流读取XML的Document。 如果encodingStr为null或是""，那么采用缺省编码GB2312
     *
     * @param inputSource
     *            输入源
     * @param encoding
