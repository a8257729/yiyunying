 ...
 * All rights reserved.
 */
package com.ztesoft.mobile.common.xwork.result;
 ...
 * 进行责任连调用的result转发类
 */
public class ActionChainResult implements ActionResult {
    ...
    public void execute(ActionInvocation invocation) throws Exception {
      ...
      //  addToHistory(finalNamespace, finalActionName, finalMethodName);
        ...
        proxy = DedicatedActionProxyFactory.getFactory().createActionProxy(finalNamespace, finalActionName, extraContext);
        if (null != finalMethodName) {
            proxy.setMethod(finalMethodName);
        }
        ((Action)proxy.getAction()).execute();
    }
