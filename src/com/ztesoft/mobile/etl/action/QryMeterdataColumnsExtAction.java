...
public class QryMeterdataColumnsExtAction implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,
		...
		System.out.println("QryMeterdataColumnsExtAction param:" + paramMap);
		// pagination info
		...
		try {
			Map retMap = getDAO().selMeterDataColumnsByTab(paramMap, start, limit);
			...
			System.out.println("QryMeterdataColumnsExtAction -jsonStr:"
					+ jsonStr);
