...
/**
 * description ：规则监控列表Action
 * @author FL
 *
 */
public class QryMonitorRulesAction implements BaseAction {
	...
	public Object doAction(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			Map retMap = getSchMonitorDAO().getRuleList(paramMap,start,limit);
			...
			System.out.println("QryMonitorRulesAction jsonStr:----->: " + jsonStr);
