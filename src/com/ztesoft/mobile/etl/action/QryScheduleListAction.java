...
/**
 * description : 调度方案列表查询Action
 * @author FL
 *
 */
public class QryScheduleListAction implements BaseAction { 
	...
	public Object doAction(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			Map retMap = getScheduleMngDAO().getScheduleList(paramMap,start,limit);
			...
			System.out.println("QryScheduleListAction jsonStr:----->: " + jsonStr);
