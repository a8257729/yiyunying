...
public class QryTacheRuleListExtAction implements BaseAction {

	public Object doAction(HttpServletRequest request,
			HttpServletResponse response) {
		ParamUtils paramUtils = new ParamUtils();
		Map paramMap = paramUtils.getMapByRequest(request);
		System.out.println("QryTacheRuleListExtAction paramMap: " + paramMap);
		...
		try {
			...
			Map retMap = getDAO().queryAllEtlTacheRule(paramMap, start, limit);
			...
			System.out.println("QryTacheRuleListExtAction jsonStr:----->: "
					+ jsonStr);
