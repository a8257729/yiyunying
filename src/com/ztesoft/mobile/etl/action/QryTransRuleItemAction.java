...
public class QryTransRuleItemAction extends AbstractAction {
	public String execute() throws Exception {
		Map paramMap = (Map) DedicatedActionContext.getParams().get(
				"parameter_1");
		System.out.println("QryTransRuleItemAction paramMap:" + paramMap);
		Map transRule = getDAO().selById(paramMap);
		System.out.println("QryTransRuleItemAction: " + transRule);
