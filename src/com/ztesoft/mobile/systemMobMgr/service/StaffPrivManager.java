package com.ztesoft.mobile.systemMobMgr.service;
...
import com.ztesoft.mobile.systemMobMgr.util.StaffPrivJsonUtil;
...
public class StaffPrivManager implements SessionBean {
	 ...
	 * @throws Exception 
     */
    public static String findPrivsJobNotHoldJson(int jobId, int defaultJobId) throws Exception {
        try {
        	
            Privilege[] privs = getMobPrivDAO().selAllPriv(jobId, defaultJobId);  
            
            Map privClassMap = null;// getMobMunePrDAO().getAllPrivData();
