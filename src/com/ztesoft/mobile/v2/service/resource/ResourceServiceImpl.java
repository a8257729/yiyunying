...
//			result = parseSaPrivateWorkOrderResponse(respXml);
	...
	public String getResourceOrderBySpectroscope(String direName, String condition, String timer1, String timer2, Integer pageIndex, Integer pageSize, String staffId) {
		String result = null;
		try {
			result = getResourceDAO().getResouceOrderList(direName,condition,timer1,timer2,pageIndex,pageSize,staffId);
//			result = parseSaPrivateWorkOrderResponse(respXml);
		} catch (Exception e) {
			if (logger.isDebugEnabled()) {
				logger.debug(e.getMessage());
	...
	public String getObdOrderById(String id) {
		String result = null;
		try {
			result = getResourceDAO().getResouceObdOrderList(id);
//			result = parseSaPrivateWorkOrderResponse(respXml);
		} catch (Exception e) {
			if (logger.isDebugEnabled()) {
				logger.debug(e.getMessage());
	...
	public void updateResCleanOrderState(String id) {
		String result = null;
		try {
			getResourceDAO().updateResOrderState(id);
//			result = parseSaPrivateWorkOrderResponse(respXml);
		} catch (Exception e) {
			if (logger.isDebugEnabled()) {
				logger.debug(e.getMessage());
...
//			result = parseSaPrivateWorkOrderResponse(respXml);
	...
	public String getWorkOrderChannel(String workOrderID) {
		String result = null;
		try {
			result = getResourceDAO().selWorkOrderChannel(workOrderID);
		} catch (Exception e) {
			if (logger.isDebugEnabled()) {
				logger.debug(e.getMessage());
			}
