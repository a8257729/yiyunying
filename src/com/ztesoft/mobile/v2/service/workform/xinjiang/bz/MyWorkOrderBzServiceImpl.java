...
public class MyWorkOrderBzServiceImpl extends BaseService implements
		MyWorkOrderBzService {
	...
	private  WorkFlowDao wf = new WorkFlowDaoImpl();
...
//						reqXml);
//			}
			respXml = this.wf.getSAInfoList(username, jobId, pageSize, pageIndex);
	...
	public Result selZdPrivateWorkOrderByPage(String username, Long jobId,
											  Integer pageSize, Integer pageIndex) {
		Result result = null;
...
//						reqXml);
//			}
			respXml = this.wf.getZdInfoList(username, jobId, pageSize, pageIndex);
			result = parseSaPrivateWorkOrderResponse(respXml);
...
//							nn19.getText() == null ? "" : nn19.getText());
	...
	//				nn20.getText() == null ? "" : nn20.getText());
					...
					map_.put(WorkOrderKt.ORDER_URGE_FLAG,
